...
def generate_launch_description():
    ...
    # Create a node for the Odom - TF transformation
    ...
    static_tf_pub_node = Node(
        ...
        arguments=['0', '0', '0', '0', '0', '0', 'laser_frame', 'differential_drive_robot/body_link/laser_frame'],
        output='screen'
    )

    lidar_msg_node = Node(
            package=package_name,
            executable='lidar_read_node.py',
            name='lidar_read_node',
            output='screen'
        )
